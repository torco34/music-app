<!-- <template>
  <div class="banner">
    <div class="container">
      ...
      <div class="image-wrapper" @click="triggerFileInput" @mouseover="showOverlay = true" @mouseleave="showOverlay = false">
        <q-img :src="localImageSrc" class="banner-image" />


        <div v-if="showOverlay" class="overlay">
          <span class="overlay-text">Subir o elegir imagen</span>
        </div>
